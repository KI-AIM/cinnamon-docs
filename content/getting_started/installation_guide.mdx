...
Download the [docker-compose.yml](https://github.com/KI-AIM/KI-AIM-Platform/blob/main/docker-compose.yml) from Cinnamon's repository.
Set the password of the database user in the downloaded file.
This has to be done for the cinnamon-db and cinnamon-platform services.
...
Running the following command in the directory of the `docker-compose.yml` starts all modules:
...
### Build
First, clone the [Cinnamon repository](https://github.com/KI-AIM/KI-AIM-Platform/tree/main) from GitHub.

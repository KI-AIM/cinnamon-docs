...
Cinnamon's workflow is dynamic because of its modularity and configurability.
...
Datasets containing the original data and results are stored together with their metadata in the platform.
